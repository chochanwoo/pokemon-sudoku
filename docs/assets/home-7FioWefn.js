import{i as r,s,t as a,l as n,g as o,c as l,L as d,A as c,G as p}from"./style-Dh-Hqj8I.js";const h=""+new URL("typedoku-preview-B8yMirdL.png",import.meta.url).href,m=""+new URL("pokemantle-preview-CPWxnIqg.png",import.meta.url).href,g=""+new URL("typedoku-preview-en-B53C74ZQ.png",import.meta.url).href,u=""+new URL("pokemantle-preview-en-BEnqBw6W.png",import.meta.url).href,t=[{id:"typedoku",title:"타입도쿠",category:"스도쿠",formats:"4 × 4 · 6 × 6 · 9 × 9",href:"./sudoku.html",image:h,imageEn:g,imageAlt:"포켓몬과 타입 아이콘이 배치된 타입도쿠 4 × 4 보드"},{id:"pokemantle",title:"포맨틀",category:"유사도 추리",formats:"데일리",href:"./pokemantle.html",image:m,imageEn:u,imageAlt:"추측한 포켓몬의 유사도와 순위가 표시된 포맨틀 기록"}];r("포켓몬 퀴즈",i);new URLSearchParams(location.search).has("seed")?location.replace(`./sudoku.html${location.search}${location.hash}`):i();function i(){document.querySelector("#app").innerHTML=`
