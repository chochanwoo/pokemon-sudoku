import{i as r,s as n,t as a,l as s,g as o,c as l,L as c,A as p,G as d}from"./style-BRAQq4Nr.js";const m=""+new URL("typedoku-preview-B8yMirdL.png",import.meta.url).href,h=""+new URL("pokemantle-preview-CPWxnIqg.png",import.meta.url).href,g=""+new URL("typedoku-preview-en-B53C74ZQ.png",import.meta.url).href,u=""+new URL("pokemantle-preview-en-BEnqBw6W.png",import.meta.url).href,f=""+new URL("pokeclue-preview-Djnt1yz9.png",import.meta.url).href,v=""+new URL("pokeclue-preview-en-r7CxjnpD.png",import.meta.url).href,t=[{id:"typedoku",title:"타입도쿠",category:"스도쿠",formats:"4 × 4 · 6 × 6 · 9 × 9",href:"./sudoku.html",image:m,imageEn:g,imageAlt:"포켓몬과 타입 아이콘이 배치된 타입도쿠 4 × 4 보드"},{id:"pokemantle",title:"포맨틀",category:"유사도 추리",formats:"데일리",href:"./pokemantle.html",image:h,imageEn:u,imageAlt:"추측한 포켓몬의 유사도와 순위가 표시된 포맨틀 기록"},{id:"pokeclue",title:"포케클루",category:"단서 추리",formats:"데일리 · 연습",href:"./pokeclue.html",image:f,imageEn:v,imageAlt:"타입과 특성 등 여섯 가지 단서를 비교한 포케클루 추측 기록"}];r("포켓몬 퀴즈",i);new URLSearchParams(location.search).has("seed")?location.replace(`./sudoku.html${location.search}${location.hash}`):i();function i(){document.querySelector("#app").innerHTML=`
    <header class="site-header"><div class="header-inner">
      ${n()}
      <div class="header-actions"><span class="hub-header-label">${a("비공식 팬 게임")}</span>${s()}</div>
    </div></header>
    ...
    </main>`,l({icons:{Gamepad2:d,ArrowRight:p,Languages:c},attrs:{"stroke-width":1.8}})}
